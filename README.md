...
> 유튜브 영상 속 상품을 캡처하고, AI 분석과 검색을 통해 유사 상품을 추천하는 쇼핑 연계 서비스

<br/>

## 1. 프로젝트 소개

**SyncShopper**는 유튜브 영상을 시청하다가 마음에 드는 상품을 발견했을 때, 사용자가 직접 검색어를 고민하지 않아도 상품을 쉽게 찾을 수 있도록 돕는 서비스입니다.

사용자는 크롬 익스텐션을 통해 영상 속 특정 영역을 캡처할 수 있고, AI 서버는 캡처 이미지와 OCR 정보를 분석하여 상품 특징을 추출합니다. 이후 네이버 쇼핑 검색과 Gemini 기반 검색 결과를 활용해 유사 상품 후보를 수집하고, 최종적으로 사용자에게 관련 상품을 추천합니다.
